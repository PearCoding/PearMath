...
bool vectorTest()
{
	...
	CHECK_TEST3(pm_IsEqual(r, pm_Set(50, 50, 50)), op1, op2, r, pm_Set(50, 50, 50))
		END_TEST()
	...
	CHECK_TEST3(pm_IsEqual(r, pm_Set(-10, 40, 60)), op1, op2, r, pm_Set(-10, 40, 60))
		END_TEST()

		START_TEST("Vector * float");
	vec3 op1 = pm_Set(10, 20, 30);
	TEST(vec3 r = pm_Scale(op1, 60));
	CHECK_TEST3(pm_IsEqual(r, pm_Set(600, 1200, 1800)), op1, 60, r, pm_Set(600, 1200, 1800))
		END_TEST()
	...
	CHECK_TEST3(pm_IsEqual(r, pm_Set(3000, 1200, 700)), op1, op2, r, pm_Set(3000, 1200, 700))
		END_TEST()
	...
	CHECK_TEST3(pm_IsEqual(r, pm_Set(25, 30, 35)), op1, op2, r, pm_Set(25, 30, 35))
		END_TEST()

		START_TEST("Reciprocal Vector");
	vec3 op1 = pm_Set(10, 20, 40);
	TEST(vec3 r = pm_Reciprocal(op1));
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.1f, 0.05f, 0.025f), ABSOLUTE_ERROR), op1, r, pm_Set(0.1f, 0.05f, 0.025f))
		END_TEST()

		START_TEST("SQRT Vector");
	vec3 op1 = pm_Set(10, 20, 40);
	TEST(vec3 r = pm_Sqrt(op1));
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(3.16227766016838f, 4.47213595499958f, 6.324555320336759f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.31622776601684f, 0.22360679774998f, 0.15811388300842f), ABSOLUTE_ERROR),
	...
	CHECK_TEST3(pm_IsEqual(r, pm_Set(10, 400, 2560000)), op1, op2, r, pm_Set(10, 400, 2560000))
		END_TEST()

		START_TEST("Exp Vector");
	vec3 op1 = pm_Set(10, 20, 40);
	TEST(vec3 r = pm_Exp(op1));
	CHECK_TEST2(pm_IsEqual(r, pm_Set(22026.46579480672f, 4.8516519540979028e8f, 2.3538526683702e17f)),
	...
	CHECK_TEST2(pm_IsEqual(r, pm_Set(2.302585092994046f, 2.995732273553991f, 3.688879454113936f)),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.59847214410396f, -0.59847214410396f, 0.04158066243329f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(-0.80114361554693f, -0.80114361554693f, -0.99913515027328f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.10033467208545f, 0, 1.557407724654902f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(1.570796326794897f, 0, 0.5235987755983f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0, 1.570796326794897f, 1.047197551196598f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(1.262627255678912f, 0.78539816339745f, 1.10714871779409f), ABSOLUTE_ERROR),
	...
	CHECK_TEST3(pm_IsNearlyEqual(r, pm_Set(30, 10, 3.0), ABSOLUTE_ERROR), op1, op2, r, pm_Set(30, 10, 3.0))
		END_TEST()
	...
	CHECK_TEST3(pm_IsNearlyEqual(r, pm_Set(0.94417967980259f, 0.3147265599342f, 0.094417967980259f), ABSOLUTE_ERROR),
	...
	CHECK_TEST3(pm_IsNearlyEqual(r, pm_Set(0.50610424149908f, 0.29738467847613f, 0.65479658073714f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsEqual(r, pm_Set(1, 0, 1)), op1, r, pm_Set(1, 0, 1))
		END_TEST()
	...
	CHECK_TEST3(pm_IsNearlyEqual(r, pm_Set(-6, -1, 3), ABSOLUTE_ERROR), op1, op2, r, pm_Set(-6, -1, 3))
		END_TEST()
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(1, 0, 0), ABSOLUTE_ERROR), op1, r, pm_Set(1, 0, 0))
		END_TEST()
