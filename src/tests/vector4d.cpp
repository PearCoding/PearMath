...
bool vectorTest()
{
	...
	CHECK_TEST3(pm_IsEqual(r, pm_Set(10, 10, 10, 10)), op1, op2, r, pm_Set(10, 10, 10, 10))
		END_TEST()

		START_TEST("Reciprocal Vector");
	vec4 op1 = pm_Set(10, 20, 40, 80);
	TEST(vec4 r = pm_Reciprocal(op1));
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.1f, 0.05f, 0.025f, 0.0125f), ABSOLUTE_ERROR), op1, r, pm_Set(0.1f, 0.05f, 0.025f, 0.0125f))
		END_TEST()

		START_TEST("SQRT Vector");
	vec4 op1 = pm_Set(10, 20, 40, 80);
	TEST(vec4 r = pm_Sqrt(op1));
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(3.16227766016838f, 4.47213595499958f, 6.324555320336759f, 8.944271909999159f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.31622776601684f, 0.22360679774998f, 0.15811388300842f, 0.11180339887499f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.59847214410396f, -0.59847214410396f, 0.04158066243329f, 0.4794255386042f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(-0.80114361554693f, -0.80114361554693f, -0.99913515027328f, 0.87758256189037f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.10033467208545f, 0, 1.557407724654902f, 0.54630248984379f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(1.570796326794897f, 0, 0.5235987755983f, -0.5235987755983f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0, 1.570796326794897f, 1.047197551196598f, 2.094395102393196f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(1.262627255678912f, 0.78539816339745f, 1.10714871779409f, 0), ABSOLUTE_ERROR),
	...
	CHECK_TEST3(pm_IsNearlyEqual(r, pm_Set(30, 10, 3.0, 0.75f), ABSOLUTE_ERROR), op1, op2, r, pm_Set(30, 10, 3.0, 0.75f))
		END_TEST()
	...
	CHECK_TEST3(pm_IsNearlyEqual(r, pm_Set(0.94417967980259f, 0.3147265599342f, 0.094417967980259f, 0.023604491995065f), ABSOLUTE_ERROR),
	...
	CHECK_TEST3(pm_IsNearlyEqual(r, pm_Set(0.50610424149908f, 0.29738467847613f, 0.65479658073714f, 0.47609062960663f), ABSOLUTE_ERROR),
	...
	CHECK_TEST2(pm_IsNearlyEqual(r, pm_Set(0.5f, 0.5f, 0.5f, 0.5f), ABSOLUTE_ERROR), op1, r, pm_Set(0.5f, 0.5f, 0.5f, 0.5f))
		END_TEST()
